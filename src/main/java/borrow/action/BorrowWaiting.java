...
public class BorrowWaiting implements Action {
	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listCount=bookListService.bookCount(); //총 리스트 수를 받아옴.
		
		articleList = bookListService.getBbookList(page,limit); //리스트를 받아옴.
		//총 페이지 수.
		...
		ActionForward forward= new ActionForward();
   		forward.setPath("/book/bookLoanW.jsp");
   		return forward;

...
import inform.svc.InformWriteProService2;
import inform.vo.ActionForward;
import inform.vo.InformBean;

public class InformWrite2ProAction implements Action {
...
//		realFolder = context.getRealPath(saveFolder);
		...
		InformBean.setInform_PASS(multi.getParameter("inform_PASS"));
		...
		InformWriteProService2 informWriteProService2 = new InformWriteProService2();
		boolean isWriteSuccess = informWriteProService2.registArticle(InformBean);
		...
		if (!isWriteSuccess) {
			...
			forward.setPath("informList2.bo");
		}

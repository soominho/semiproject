...
<jsp:include page="/header.jsp"></jsp:include>
   <div class="wrap" id="wrap">
      <form name="modifyform" action="memberModifyActionUser.me" method="post">
         <div>
            <h2>회원정보 수정</h2>
            ...
            <table class="section top">
               ...
               <tr>
                  ...
                  <td colspan="3"><input type="password" class="menu_h" name="pw" id="pw" minlength="8" maxlength="16" pattern="[a-zA-Z0-9_\-~!@#$%^&*()]+" placeholder="비밀번호 입력" required/>
                  </td>
                </tr>
                <tr>
                  <td><label for="pw1">비밀번호확인</label></td>
                  <td colspan="3">
                  <input type="password" class="menu_h" name="pw1" id="pw1" minlength="8" maxlength="16" pattern="[a-zA-Z0-9_\-~!@#$%^&*()]+" placeholder="비밀번호 확인" required>
                  </td>
                </tr>
               <tr>
            ...
            <div  class="btnwrap">
                  ...
                  <button type="button" class="menu_btn1" onclick="pwchk()">수정하기</button>
...
<script>
      ...
      function pwchk(){
            ...
            if(p1 == ""){
               ...
               alert("정보가 업데이트 되었습니다. 로그인 페이지로 이동합니다.");
               modifyform.submit();
            }
         }
   </script>

...
<body>
	...
	<div style="height: 150px;">
		<img style="width: 100%; height: 1050px" src="./img/배경1.jpg">
	</div>

	<!-- PC 버전 -->
	<div class="navbar_main">
		<a class="navbar_logo" href="mainex.jsp"><img style="width: 70px;"
			src="./img/logow.png"></a>
		...
		<c:choose>
			<c:when test="${id eq null }">
				<div class="top-bar">
					<a href="memberLogin.me">로그인</a> <a href="terms.jsp">회원가입</a>
				</div>
			</c:when>
			...
			<c:otherwise>
				<div class="bbb">
					<form class="bb1" action="Logout.jsp" method="post">
						...
						<input type="hidden" name="id" autocomplete='off'> <input
							type="hidden" name="pwd" autocomplete='off'> <a
							href="logout">로그아웃</a> <a href="UserMypage.jsp">마이페이지</a>
					</form>
				</div>
			</c:otherwise>
		</c:choose>
	...
	<div
		style="background-color: #fff; width: 100%; height: 900px; position: absolute; margin: 0; z-index: 0;">
	</div>
...
<script>
	document.querySelector('.menu-toggle').addEventListener(
			'click',
			function() {
				document.querySelector('.navbar_links').classList
						.toggle('active');
			});
</script>
</html>
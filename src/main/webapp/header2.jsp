...
.navbar_links.active {
  ...
  .e1{
     background: url('./img/로그인.png') center center/50% no-repeat;
     text-decoration-line: none;
  }
  .e1 > span {
     color : transparent;
  ...
  .e2{
     background: url('./img/회원가입.png') center center/50% no-repeat;
     text-decoration-line: none;
  }
  .e2 > span {
     color : transparent;
...
<body>
  ...
  <div style="height: 150px; "><img style="width: 100%; height:1050px" src="./img/배경1.jpg"></div>
  
  <!-- PC 버전 -->
<div class="navbar_main">
  <a class="navbar_logo" href="mainex.jsp"><img style="width:70px;" src="./img/logow.png"></a>
  ...
  <c:set var="id" value="${sessionScope.id }" />
      <c:choose>
         <c:when test="${id eq null }">
            <div class="top-bar">
                <a href="memberLogin.me" class="e1"><span>로그인</span></a>
                <a href="terms.jsp" class="e2"><span>회원가입</span></a>
            </div>
         </c:when>
         <c:when test="${id eq 'admin' }">
            <div class="bbb">
               <form class="bb1" action="Logout.jsp" method="post">
               <span style="color: #fff;"><%=session.getAttribute("id") + "(관리자)님이 로그인 성공하셨습니다."%></span>
      ...
      <div style=" background-color:#fff; width: 100%; height: 900px; position: absolute;  margin: 0; z-index: 0;">
      </div>

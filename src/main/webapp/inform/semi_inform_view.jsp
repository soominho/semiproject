         ...
         <table>
            ...
            <tr>
                ...
                <td class="td_right">
                    ...
                    <img src="./informUpload/<%=article.getInform_FILES() %>">
                    <br>
         ...
         <section id="commandCell">
          <%if(article.getInform_NM().equals(session.getAttribute("id"))){%>
            <a class="wow" href="informModifyForm.bo?inform_num=<%=article.getInform_NUM() %>&page=${page }"> 수정 </a>
      		<a class="wow" href="informDeletePro.bo?inform_num=<%=article.getInform_NUM() %>&page=${page }"> 삭제 </a>
      		<%} %>
            <a class="wow" href="informList.bo?page=${page }"> 목록 </a>&nbsp;&nbsp;
         </section>
      </form>
   </section>
   <!-- 게시판 등록 -->
